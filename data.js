...
const COPA_DATA = {
  ...
  teams: {
    ...
    Brazil: { rating: 94, market: 95, tradition: 100, fifa: 5 },
    França: { rating: 95, market: 96, tradition: 94, fifa: 2 },
    France: { rating: 95, market: 96, tradition: 94, fifa: 2 },
    Inglaterra: { rating: 92, market: 95, tradition: 88, fifa: 4 },
    England: { rating: 92, market: 95, tradition: 88, fifa: 4 },
    Espanha: { rating: 91, market: 93, tradition: 90, fifa: 3 },
    Spain: { rating: 91, market: 93, tradition: 90, fifa: 3 },
    Portugal: { rating: 89, market: 91, tradition: 84, fifa: 6 },
    Marrocos: { rating: 84, market: 81, tradition: 80, fifa: 12 },
    Morocco: { rating: 84, market: 81, tradition: 80, fifa: 12 },
    Japão: { rating: 80, market: 78, tradition: 76, fifa: 18 },
    Japan: { rating: 80, market: 78, tradition: 76, fifa: 18 },
    Austria: { rating: 81, market: 79, tradition: 77, fifa: 21 },
    Suíça: { rating: 82, market: 80, tradition: 79, fifa: 17 },
    Switzerland: { rating: 82, market: 80, tradition: 79, fifa: 17 },
    Algeria: { rating: 79, market: 76, tradition: 72, fifa: 28 },
    Noruega: { rating: 83, market: 88, tradition: 72, fifa: 24 },
    Norway: { rating: 83, market: 88, tradition: 72, fifa: 24 },
    'Costa do Marfim': { rating: 78, market: 75, tradition: 75, fifa: 36 },
    'Ivory Coast': { rating: 78, market: 75, tradition: 75, fifa: 36 },
    'DR Congo': { rating: 74, market: 70, tradition: 68, fifa: 54 },
    Panama: { rating: 68, market: 62, tradition: 60, fifa: 52 },
    Jordan: { rating: 65, market: 58, tradition: 55, fifa: 67 },
    'Cabo Verde': { rating: 73, market: 69, tradition: 60, fifa: 49 },
    'Cape Verde': { rating: 73, market: 69, tradition: 60, fifa: 49 }
  },
  matches: [
    { date: '2026-06-26', stage: 'Grupo I', home: 'Noruega', away: 'França', homeScore: 1, awayScore: 4, status: 'Finalizado' },
    { date: '2026-06-27', stage: 'Grupo L', home: 'Panama', away: 'Inglaterra', homeScore: 0, awayScore: 2, status: 'Finalizado' },
    { date: '2026-06-28', stage: 'Grupo J', home: 'Argentina', away: 'Jordan', homeScore: 3, awayScore: 1, status: 'Finalizado' },
    { date: '2026-06-28', stage: 'Grupo J', home: 'Algeria', away: 'Austria', homeScore: 3, awayScore: 3, status: 'Finalizado' },
    ...
    { date: '2026-07-01', stage: 'Mata-mata', home: 'Inglaterra', away: 'DR Congo', status: 'Agendado' },
    { date: '2026-07-02', stage: 'Mata-mata', home: 'Espanha', away: 'Austria', status: 'Agendado' },
